 ...
 * @author leobin
 */
public class TreeViewEventForCelerate implements TreeSelectionListener {

    JTree tree;
    boolean checkClhange = true;
    private CaliratePanel parentPanel = null;

    public TreeViewEventForCelerate(CaliratePanel aThis, JTree tree) {
