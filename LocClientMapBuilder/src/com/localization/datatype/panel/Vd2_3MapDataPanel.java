...
public class Vd2_3MapDataPanel extends DataTypeAbstractPanel implements ActionListener{
    ...
    private void startScanJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startScanJButtonActionPerformed
                ...
                try {
                    ...
                    collector.startCollecting(null, LocationManagementPanel.selectedLocation.getLocationId(), LocalizationMain.loginUser.getUserId(), isAppend, Double.parseDouble(this.inputScanningFrequency.getText()));
                    elapseTime = 0;
                    timer.start();
                } catch (Exception e) {
    ...
    private void endScanJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_endScanJButtonActionPerformed
                ...
                String saveFilePath = ApplicationConfiguration.load().dataFolder + "/" + LocationManagementPanel.selectedLocation.getLocationId() + "_" + LocalizationMain.loginUser.getUserId() + "_" + mapAllDTO.get(Vd2_3MapData.DATATYPE_CLASSNAME).getDataTypeId() + CommonConfig.extensionMapDataFile;
                MapData.writeMapData(vd2_3MapData, saveFilePath);

                saveFilePath = ApplicationConfiguration.load().dataFolder + "/" + LocationManagementPanel.selectedLocation.getLocationId() + "_" + LocalizationMain.loginUser.getUserId() + "_" + mapAllDTO.get(WifiMapData.class.getName()).getDataTypeId() + CommonConfig.extensionMapDataFile;
