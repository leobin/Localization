...
# Target DBMS:           MySQL 5                                         #
# Project file:          database_v0.4.dez                               #
# Project name:                                                          #
# Author:                                                                #
# Script type:           Database creation script                        #
# Created on:            2010-12-29 16:00                                #
# ---------------------------------------------------------------------- #
...
CREATE TABLE `location` (
    ...
    `parent_location_id` BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE `mac_address_location` (
    ...
    CONSTRAINT `PK_mac_address_location` PRIMARY KEY (`mac_address_id`, `location_id`)
);
...
# ---------------------------------------------------------------------- #
# Add table "data_type_algorithm"                                        #
# ---------------------------------------------------------------------- #

CREATE TABLE `data_type_algorithm` (
    `data_type_id` BIGINT NOT NULL,
    `algorithm_id` BIGINT UNSIGNED NOT NULL,
    CONSTRAINT `PK_data_type_algorithm` PRIMARY KEY (`data_type_id`, `algorithm_id`)
);

# ---------------------------------------------------------------------- #
# Add table "location_Algorithm"                                         #
# ---------------------------------------------------------------------- #

CREATE TABLE `location_Algorithm` (
    `location_id` BIGINT UNSIGNED NOT NULL,
    `algorithm_id` BIGINT UNSIGNED NOT NULL,
    CONSTRAINT `PK_location_Algorithm` PRIMARY KEY (`location_id`, `algorithm_id`)
);
...
ALTER TABLE `data_type_algorithm` ADD CONSTRAINT `data_type_data_type_algorithm` 
    FOREIGN KEY (`data_type_id`) REFERENCES `data_type` (`data_type_id`);

ALTER TABLE `data_type_algorithm` ADD CONSTRAINT `algorithm_data_type_algorithm` 
    FOREIGN KEY (`algorithm_id`) REFERENCES `algorithm` (`algorithm_id`);

ALTER TABLE `location_Algorithm` ADD CONSTRAINT `location_location_Algorithm` 
    FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`);

ALTER TABLE `location_Algorithm` ADD CONSTRAINT `algorithm_location_Algorithm` 
    FOREIGN KEY (`algorithm_id`) REFERENCES `algorithm` (`algorithm_id`);
